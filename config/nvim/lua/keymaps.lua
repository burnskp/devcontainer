...
vim.keymap.set("n", "<C-j>", "<C-w>j", { desc = "Right Window"})
vim.keymap.set("n", "<C-k>", "<C-w>k", { desc = "Up Window" })
vim.keymap.set("n", "<C-l>", "<C-w>l", { desc = "Down Window" })
vim.keymap.set("n", "<C-n>", "<cmd>bn<CR>", { desc = "Next buffer" })
vim.keymap.set("n", "<C-p>", "<cmd>bp<CR>", { desc = "Previous buffer" })
vim.keymap.set("n", "<leader>ka", function()
  require("sidekick.cli").toggle({ name = "opencode", focus = true }) end, { desc = "Toggle OpenCode" }) vim.keymap.set("n", "<leader>kd", function() require("sidekick.cli").close() end, { desc = "Close sidekick" })
vim.keymap.set("n", "<leader>kf", function() require("sidekick.cli").send({ msg = "{file}" }) end, { desc = "Send file to sidekick" })
vim.keymap.set("n", "<leader>kp", function() require("sidekick.cli").prompt() end, { desc = "Sidekick prompt" })
vim.keymap.set("n", "<leader>kt", function() require("sidekick.cli").send({ msg = "{this}" }) end, { desc = "Send selection to sidekick" })
...
vim.keymap.set("n", "<leader>d", "<cmd>bd<CR>", { desc = "Delete buffer" }) vim.keymap.set("n", "<leader>D", function()
