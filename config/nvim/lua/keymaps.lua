...
vim.keymap.set("c", "<S-Enter>",   function() require("noice").redirect(vim.fn.getcmdline()) end, { desc = "Redirect command to Noice" })

vim.keymap.set("i", "<c-k>",function() return vim.lsp.buf.signature_help() end, { desc = "Show signature help" })
...
vim.keymap.set("n", "<leader>aa", function() require("sidekick.cli").toggle({ name = "opencode", focus = true }) end, { desc = "Toggle OpenCode" })
vim.keymap.set("n", "<leader>ad", function() require("sidekick.cli").close() end, { desc = "Close sidekick" })
vim.keymap.set("n", "<leader>af", function() require("sidekick.cli").send({ msg = "{file}" }) end, { desc = "Send file to sidekick" })
vim.keymap.set("n", "<leader>ap", function() require("sidekick.cli").prompt() end, { desc = "Sidekick prompt" })
vim.keymap.set("n", "<leader>at", function() require("sidekick.cli").send({ msg = "{this}" }) end, { desc = "Send selection to sidekick" })
...
vim.keymap.set("n", "<leader>D", function() Snacks.bufdelete(0, { force = true }) end, { desc = "Delete buffer (force)" })
vim.keymap.set("n", "<leader>e", "<cmd>lua vim.diagnostic.open_float()<CR>", { desc = "Show diagnostics" })
vim.keymap.set("n", "<leader>fd", function() Snacks.picker.diagnostics_buffer() end, { desc = "Pick buffer diagnostics" })
vim.keymap.set("n", "<leader>ff", function() pick_files() end, { desc = "Pick files" })
vim.keymap.set("n", "<leader>fg", function() pick_grep() end, { desc = "Grep files" })
vim.keymap.set("n", "<leader>fG", function() Snacks.picker.grep_buffers() end, { desc = "Grep all buffers" })
vim.keymap.set("n", "<leader>fi", function() Snacks.picker.grep() end, { desc = "Search in buffers" })
vim.keymap.set("n", "<leader>fj", function() Snacks.picker.jumps() end, { desc = "Pick jump" })
vim.keymap.set("n", "<leader>fl", function() Snacks.picker.loclist() end, { desc = "Pick location list" })
vim.keymap.set("n", "<leader>fm", function() Snacks.picker.marks() end, { desc = "Pick mark" })
vim.keymap.set("n", "<leader>fP", function() Snacks.picker.projects() end, { desc = "Pick project" })
vim.keymap.set("n", "<leader>fq", function() Snacks.picker.qflist() end, { desc = "Pick quickfix" })
vim.keymap.set("n", "<leader>fr", function() Snacks.picker.recent() end, { desc = "Pick recent files" })
vim.keymap.set("n", "<leader>ft", function() Snacks.explorer.open() end, { desc = "Toggle explorer" })
vim.keymap.set("n", "<leader>fu", function() Snacks.picker.undo() end, { desc = "Pick undo" })
vim.keymap.set("n", "<leader>gb", function() Snacks.git.blame_line() end, { desc = "Git blame (current line)" })
vim.keymap.set("n", "<leader>gd", function() Snacks.picker.git_diff() end, { desc = "Pick git diff" })
...
vim.keymap.set("n", "<leader>gl", function() Snacks.gitbrowse() end, { desc = "Open in git browser" })
vim.keymap.set("n", "<leader>gl", function() Snacks.picker.git_log() end, { desc = "Git log" })
vim.keymap.set("n", "<leader>gL", function() Snacks.picker.git_log_line() end, { desc = "Git log (current line)" })
vim.keymap.set("n", "<leader>gr", function() Snacks.picker.git_branches() end, { desc = "Pick git branch" })
vim.keymap.set("n", "<leader>gS", function() Snacks.picker.git_stash() end, { desc = "Pick git stash" })
vim.keymap.set("n", "<leader>gs", function() Snacks.picker.git_status() end, { desc = "Git status" })
vim.keymap.set("n", "<leader>gv", function() if next(require('diffview.lib').views) == nil then vim.cmd('DiffviewOpen') else vim.cmd('DiffviewClose') end end, { desc = "Toggle diffview" })
...
vim.keymap.set("n", "<leader>ll", function() Snacks.picker.lsp_config() end, { desc = "LSP configuration" })
...
vim.keymap.set("n", "<leader>uNa", function() require("noice").cmd("all") end, { desc = "Noice all" })
vim.keymap.set("n", "<leader>uNd", function() require("noice").cmd("dismiss") end, { desc = "Dismiss Noice" })
vim.keymap.set("n", "<leader>uNh", function() require("noice").cmd("history") end, { desc = "Noice history" })
vim.keymap.set("n", "<leader>uNl", function() require("noice").cmd("last") end, { desc = "Noice last" })
...
vim.keymap.set("n", "<tab>", function() if not require("sidekick").nes_jump_or_apply() then return "<Tab>" end end, { desc = "Sidekick jump or apply" })
vim.keymap.set("n", "[[",         function() Snacks.words.jump(-vim.v.count1) end, { desc = "Jump to previous word" })
vim.keymap.set("n", "[l", "<cmd>lprevious<CR>", { desc = "Previous location" })
vim.keymap.set("n", "[q", "<cmd>cprevious<CR>", { desc = "Previous quickfix" })
vim.keymap.set("n", "]]",         function() Snacks.words.jump(vim.v.count1) end, { desc = "Jump to next word" })
...
vim.keymap.set("n", '<leader>f"', function() Snacks.picker.registers() end, { desc = "Pick register" })

vim.keymap.set("t", "<Esc>", "<C-\\><C-n>", { desc = "Exit terminal mode" })

vim.keymap.set("x", "<leader>ap", function() require("sidekick.cli").prompt() end, { desc = "Sidekick prompt (visual)" })
vim.keymap.set("x", "<leader>at", function() require("sidekick.cli").send({ msg = "{this}" }) end, { desc = "Send selection to sidekick (visual)" })
vim.keymap.set("x", "<leader>av", function() require("sidekick.cli").send({ msg = "{selection}" }) end, { desc = "Send selection to sidekick (visual)" })
